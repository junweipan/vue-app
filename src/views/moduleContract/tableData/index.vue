    ...
    <el-form :inline="true" :model="query" size="mini">
      ...
      <el-form-item>
        ...
        <el-button
          ...
          >新增</el-button
        >
        <el-button icon="el-icon-circle-plus-outline" type="warning" disabled
          >更新</el-button
        >
        <el-button
          icon="el-icon-circle-plus-outline"
    ...
    >
      ...
      <el-table-column align="center" label="操作" width="150" fixed>
        <template slot-scope="scope">
          <el-button
            type="success"
            @click="handleEdit(scope.row.idNo)"
            size="mini"
            >编辑</el-button
          >
          <el-button
      ...
      <el-table-column label="身份证号码" width="170" fixed>
      ...
      <el-table-column label="工作岗位" width="auto" show-overflow-tooltip>
      ...
      <el-table-column label="开户行" width="120">
        <template slot-scope="scope">{{
          scope.row.bankName | bankFormat
        }}</template>
      </el-table-column>

      <el-table-column label="银行卡号" width="170">
      ...
      <el-table-column label="毕业学校" width="auto" show-overflow-tooltip>
        <template slot-scope="scope">{{ scope.row.graduatedSchool }}</template>
      </el-table-column>

      <el-table-column label="户籍" width="auto">
      ...
      <el-table-column label="备注" width="auto" show-overflow-tooltip>
        <template slot-scope="scope">{{ scope.row.remark }}</template>
      </el-table-column>

      <el-table-column label="创建日期" width="auto" show-overflow-tooltip>
        <template slot-scope="scope">{{ scope.row.createDate }}</template>
      </el-table-column>

      <el-table-column label="创建者" width="auto" show-overflow-tooltip>
        <template slot-scope="scope">{{ scope.row.createOpr }}</template>
      </el-table-column>

      <el-table-column label="更新日期" width="auto" show-overflow-tooltip>
        <template slot-scope="scope">{{ scope.row.updateDate }}</template>
      </el-table-column>

      <el-table-column label="更新者" width="auto" show-overflow-tooltip>
