...
<div>
    <div>
        <message-detail :date="message.date" :title="message.title" :visible="dialogVisible" :message="message.detail" :handleDialogVisible='closeMessageDialog'></message-detail>
        <el-popover
            ref="popoverRef"
            placement="right"
            width="400"
